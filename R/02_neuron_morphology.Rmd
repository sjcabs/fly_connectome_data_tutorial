...
If you want to do spatial transforms yourself rather than using pre-transformed skeletons, you will need transform tools. In R, `nat.templatebrains::xform_brain` handles transforms between light-level templates, and [bancr](https://github.com/flyconnectome/bancr) completes the bridge to BANC space. For EM-level templates without R-native registrations (e.g. JRCFIB2022M), we use Python's `navis` via `reticulate`.
